...
As you know that we have add the vendor folder and .env file in git ignore so please create .env file and update it according to your database server details
